...
import (
	...
	_ "github.com/capitalrx/gitea/cmd" // for TestPrimaryKeys
...
func TestPrimaryKeys(t *testing.T) {
	...
	// Import "github.com/capitalrx/gitea/cmd" to make sure each db.RegisterModel in init functions has been called.
