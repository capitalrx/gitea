...
import (
	...
	"github.com/capitalrx/gitea/services/auth/source/smtp"

	_ "github.com/capitalrx/gitea/services/auth/source/db"   // register the sources (and below)
	_ "github.com/capitalrx/gitea/services/auth/source/ldap" // register the ldap source
	_ "github.com/capitalrx/gitea/services/auth/source/pam"  // register the pam source
	_ "github.com/capitalrx/gitea/services/auth/source/sspi" // register the sspi source
)
